...
The following data table shows the number of new cases confirmed, recovered, dead every day in Chile. And it also contains the recover and death radio calculated from cumulative cases. On 1, Sep, the recover ratio is about 93% and the death ratio is about 3%. The total number of confirmed cases in Chile is 413,145.
